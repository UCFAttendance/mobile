...
import { FaUser, FaPhone, FaEnvelope, FaLock, FaMapMarkerAlt, FaCameraRetro, FaEye } from 'react-icons/fa';
    ...
    >
      ...
      <div style={{ marginTop: '-66px', padding: '20px' }}>
        ...
        >
          ...
          {/* <Option icon={<FaUser />} label="Username" darkMode={darkMode} /> */}
          <Option icon={<FaPhone />} label="Phone Number" darkMode={darkMode} />
          <Option icon={<FaEnvelope />} label="Email" darkMode={darkMode} />
          <Option icon={<FaLock />} label="Password" darkMode={darkMode} />
          ...
          <Option icon={<FaMapMarkerAlt />} label="Location" darkMode={darkMode} />
          <Option icon={<FaCameraRetro />} label="Camera" darkMode={darkMode} />
          <Option icon={<FaEye />} label="Appearance" onClick={() => navigate('/appearance')} darkMode={darkMode} />
        </div>
      </div>
      ...
      <div style={{ marginTop: '20px', padding: '20px' }}>
        <div
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = darkMode ? '#1e1e1e' : '#fff';
