...
const CourseWidget = ({ course, attendanceRecords, index, isDarkMode }) => {
    ...
    return (
      <div className={`rounded-lg shadow-md overflow-hidden ${isDarkMode ? "bg-[#333]" : "bg-white"}`}>
        {/* Header */}
        <div style={{ backgroundColor }} className="h-[60px] flex items-center justify-between px-4 relative">
          {percentage !== "N/A" && (
            <div className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white rounded-full px-2 py-0.5"
