...
const AppContent = ({ darkMode, setDarkMode }) => {
  ...
  return (
    ...
    <div className={`app-container ${darkMode ? 'dark-theme' : 'light-theme'}`} 
      ...
      {/* Main Content Area */}
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: shouldShowBottomNav ? '60px' : '0px' }}>
      <Routes>
        ...
        {!isMobile && (
          <>
            ...
            <Route path="/dashboard" element={<StudentDashboard darkMode={darkMode} />} />
        ...
        {isMobile && (
          <>
            <Route path="/student/dashboard" element={<MobileDashboard darkMode={darkMode} />} />
            <Route path="/student/attendance" element={<ScanQR darkMode={darkMode} />} />
            <Route path="/student/history" element={<History darkMode={darkMode} />} />
            <Route path="/student/settings" element={<Settings darkMode={darkMode} />} />
          </>
        )}

        {/* Shared Routes */}
        <Route path="/appearance" element={<Appearance darkMode={darkMode} setDarkMode={setDarkMode} />} />
      </Routes>
